...
const GithubIcon = ({ className = "w-8 h-8 text-white" }: GithubIconProps) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    className={`${className} transition hover:text-stone-400`}
    viewBox="0 0 16 16"
    fill="currentColor"
  >
    <path
      ...
      2 .27c1.53-1.04 2.2-.82 2.2-.82.44 1.1.16 1.92.08 2.12.51.56.82
